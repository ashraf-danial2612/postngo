			...
			<div class="main-panel" id="main-panel">
										...
										<div class="row">
											<div class="col-md-6 pr-1">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="cname" placeholder="Enter Outlet Name">
												</div>
											</div>
											<div class="col-md-6 pl-1">
												<div class="form-group">
													<label>Outlet Email</label>
													<input type="text" class="form-control" id="cemail" placeholder="Enter Outlet Email">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="ccontact" placeholder="Enter Contact No.">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label>Address</label>
													<input type="text" class="form-control" id="caddress" placeholder="Enter Address">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6 pr-1">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="cpostcode" onchange="selectbook()" placeholder="Enter Postcode">
												</div>
											</div>
											<div class="col-md-6 pl-1">
												<div class="form-group">
													<label>State</label>
													<input type="text" class="form-control" id="cstate" disabled>
												</div>
											</div>
										</div>
										<div class="card-footer text-right">
											<button type="submit" class="btn btn-primary" onclick="add_outletlocater();return false;">Submit</button>
										</div>
									</form>
								</div>
							</div>
				...
				<script>
					...
					function add_outletlocater(){
						...
						if(cname.length < 1 || cemail.length < 1 || ccontact.length < 1 || caddress.length < 1 || cpostcode.length < 1 || cstate.length < 1)
						{
							Swal.fire({
								icon: 'error',
								title: 'Oops...',
						...
						else 
						{
							Swal.fire({
								title: 'Are you sure?',
								text: "Are you sure want to submit the new outlet locater?",
								icon: 'warning',
								...
								if (result.isConfirmed){
									$.ajax({
										type: "POST",
										url: "ajax_add_outlet_locater.php",
										data: {
											'cname' : cname,
											'cemail' : cemail,
											'ccontact' : ccontact,
