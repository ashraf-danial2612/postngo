...
<html lang="en">
	...
	<body class="user-profile">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="row">
										<div class="col-sm-3">
											<h4 class="card-title">List of Consignment</h4>
										</div>
										<div class="col-sm-3">
											<button type="submit" class="btn" style="background-color:#3b5998; color:#fff" onclick="window.location.href='add_consignment.php';">Add New</button>
										</div>
									</div>
								</div>
								<div class="card-body">
									...
									<table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
										...
										<tbody>
											<?php
												$result_consignment = mysqli_query($conn, "SELECT * FROM consignment WHERE cust_id = '".$id."'");
												$no = 1;
												...
												<tr>
													...
													<td class="text-center"><?php echo $row['cons_phone']; ?></td>
													<td class="text-center"><?php echo $row['cons_address'].", ".$row['cons_postcode'].", ".$row['cons_state']; ?></td>
													<td class="text-center"><?php echo $row['cons_pay_method']; ?></td>
													...
													<td class="text-center">
														...
														<a href="#" class="btn btn-round btn-danger btn-icon btn-sm remove" onclick="delete_consignment(this, '<?php echo $row['cons_id']; ?>');return false;""><i class="fas fa-times"></i></a>
													</td>
												</tr>
												<?php 
												}
		...
		<script>
			...
			function delete_consignment(value,consid){
				var id = consid;
				...
				Swal.fire({
					...
					if (result.isConfirmed){
						$.ajax({
							type: "POST",
							url: "ajax_delete_consignment.php",
							data: {
							'id' : id},
							dataType: "text",
							success: function(data){
								if(data == 'success'){
									Swal.fire(
									'Deleted!',
									'The consignment has been deleted.',
									'success'
									).then(function() {
