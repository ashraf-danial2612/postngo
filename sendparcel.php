  ...
  <div id="menu-wrapper">
    <div id="menu">
        ...
        <ul>
          ...
          <li class="current_page_item"><a href="sendparcel.php">Send Parcel</a></li>
  ...
  <div id="page">
    <div id="page-bgtop">
      <div id="page-bgbtm">
        ...
        <div class="current_page_item" style="float:left; margin-right : 100px">
          <a href="#" >Qr code </a>
        </div>
        <div class=" ref" style="float : left">
            <a href="sendparcel_ref.php">No. Reference </a>
        </div>
        </div>
        <div style="clear: both;">&nbsp;</div>
        <div class="qr" style="margin-left:320px">
            <img src="assets/image/qr.png" style="height:71px">
        </div>
        <div style="clear: both;">&nbsp;</div>
        <div class="button" type="submit" style="margin-left: 294px; margin-bottom:50px">Click Here</div>
      </div>
      </div>
      </div>
      </div>
